...
from software_citation.users.models import User
from software_citation.users.tests.factories import UserFactory
from software_citation.users.views import (
    UserRedirectView,
    UserUpdateView,
    user_detail_view,
)
